    ...
    public partial class MLModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options(){NumberOfLeaves=29,MinimumExampleCountPerLeaf=20,NumberOfTrees=344,MaximumBinCountPerFeature=400,FeatureFraction=0.99999999,LearningRate=0.104557057262921,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
